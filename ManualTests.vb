...
Module ManualTests
    Sub runPowerSpectralDensityMan(form As Form1, progressBarForm As ProgressBar)
        preset()
        ...
        For i = 0 To form.CheckedListBox2.Items.Count - 1 Step 1
            If form.CheckedListBox2.GetItemChecked(i) Then
                ...
                psdReadingMan(GlobalVar.freq(0), form.CheckedListBox2.Items(i).ToString, tempLocation)
                ...
                psdReadingMan(GlobalVar.freq(1), form.CheckedListBox2.Items(i).ToString, tempLocation)
                ...
                psdReadingMan(GlobalVar.freq(2), form.CheckedListBox2.Items(i).ToString, tempLocation)
            End If
        Next
        progressBarForm.SetTimer_instanceSafe(False, 0, "Power Spectral Density")
    End Sub

    Sub psdReadingMan(freq As String, protocol As String, tempLocation As String)
    ...
    End Sub
    Sub runOutBandEmmisionsMan(form As Form1, progressBarForm As ProgressBar)
        preset()
                    ...
                    If form.CheckedListBox3.GetItemChecked(y) Then
                        For j = 0 To 1 Step 1
                            ...
                            For k = 0 To 39 Step 1
                                ...
                                obeReadingMan((Convert.ToDecimal(GlobalVar.obe(0)) - (k * 1)).ToString, form.CheckedListBox2.Items(i).ToString, tempLocation)
                                'Threading.Thread.Sleep(500)
                            Next
                            For x = 0 To 39 Step 1
                                'System.Console.WriteLine((Convert.ToDecimal(GlobalVar.obe(1)) + (x * 1)).ToString)
                                obeReadingMan((Convert.ToDecimal(GlobalVar.obe(1)) + (x * 1)).ToString, form.CheckedListBox2.Items(i).ToString, tempLocation)
                                'Threading.Thread.Sleep(500)
                            Next
                        Next
                    End If
    ...
    End Sub
    Sub obeReadingMan(freq As String, protocol As String, tempLocation As String)
    ...
    End Sub
    Sub runOccupiedBandwidthMan(form As Form1, progressBarForm As ProgressBar)
        preset()
            ...
            If form.CheckedListBox2.GetItemChecked(i) Then
                ...
                For j = 0 To 1 Step 1
                    If j = 0 Then
                        ...
                        GlobalVar.offset = form.TextBox8.Text + "dB"
                        obwReadingMan(GlobalVar.freq(0), form.CheckedListBox2.Items(i).ToString, tempLocation)
                    ElseIf j = 1 Then
                        'Sharp.setChannel("top", form.CheckedListBox2.Items(i).ToString)
                        'MsgBox("Set device to channel frequency " + GlobalVar.freq(2) + "MHz on protocol " + form.CheckedListBox2.Items(i).ToString)
                        Threading.Thread.Sleep(1000)
                        'Threading.Thread.Sleep(2000)
                        GlobalVar.offset = form.TextBox10.Text + "dB"
                        obwReadingMan(GlobalVar.freq(2), form.CheckedListBox2.Items(i).ToString, tempLocation)
                    End If
    ...
    End Sub
    Sub obwReadingMan(freq As String, protocol As String, tempLocation As String)
        setCenterFreq(freq + "MHz")
